...
final class LocalContentBank: ContentGenerating {
    ...
    static let seedTexts: [WeeklyText] = [
        ...
        WeeklyText(
            ...
            keyChunks: [
                KeyChunk(expression: "wake up", meaningPT: "acordar", exampleFromText: "Ana wakes up at six thirty.", collocations: ["wake up early", "wake up late", "wake up tired"]),
                KeyChunk(expression: "get dressed", meaningPT: "se vestir", exampleFromText: "She gets dressed and goes to the kitchen.", collocations: ["get dressed quickly", "get dressed for work", "get dressed in the morning"]),
                KeyChunk(expression: "a cup of coffee", meaningPT: "uma xícara de café", exampleFromText: "She makes a cup of coffee.", collocations: ["a cup of tea", "a hot cup of coffee", "a strong cup of coffee"]),
                KeyChunk(expression: "pack her bag", meaningPT: "arrumar a bolsa/mochila", exampleFromText: "She packs her bag and leaves the house.", collocations: ["pack a bag quickly", "pack your bag the night before", "pack a school bag"]),
                KeyChunk(expression: "go to work", meaningPT: "ir trabalhar", exampleFromText: "The bus arrives, and Ana goes to work.", collocations: ["go to work by bus", "go to work early", "go to work on foot"])
            ],
            grammarPoints: [
        ...
        WeeklyText(
            ...
            keyChunks: [
                KeyChunk(expression: "leave home", meaningPT: "sair de casa", exampleFromText: "He leaves home at seven.", collocations: ["leave home early", "leave home on time", "leave home in a hurry"]),
                KeyChunk(expression: "get on the train", meaningPT: "entrar/embarcar no trem", exampleFromText: "He buys a coffee before he gets on the train.", collocations: ["get on the bus", "get on time", "get off the train"]),
                KeyChunk(expression: "find a seat", meaningPT: "achar um lugar para sentar", exampleFromText: "He doesn't always find a seat.", collocations: ["find a seat easily", "find an empty seat", "find a seat by the window"]),
                KeyChunk(expression: "check his phone", meaningPT: "checar o celular", exampleFromText: "He listens to music or checks his phone.", collocations: ["check your phone constantly", "check your messages", "check your email"]),
                KeyChunk(expression: "take (time)", meaningPT: "levar (tempo)", exampleFromText: "The journey takes about forty minutes.", collocations: ["take a long time", "take an hour", "take forever"])
            ],
            grammarPoints: [
        ...
        WeeklyText(
            ...
            keyChunks: [
                KeyChunk(expression: "get to the office", meaningPT: "chegar ao escritório", exampleFromText: "She usually gets to the office around nine.", collocations: ["get to work on time", "get to the airport early", "get to a meeting late"]),
                KeyChunk(expression: "join a meeting", meaningPT: "participar de uma reunião", exampleFromText: "She joins the morning meeting with her team.", collocations: ["join a call", "join a team", "join a conversation"]),
                KeyChunk(expression: "take notes", meaningPT: "fazer anotações", exampleFromText: "Camila took notes so she wouldn't forget the details.", collocations: ["take notes carefully", "take detailed notes", "take notes during a meeting"]),
                KeyChunk(expression: "rush into", meaningPT: "entrar às pressas", exampleFromText: "She had to rush into a meeting that had already started.", collocations: ["rush into a decision", "rush into the room", "rush into things"]),
                KeyChunk(expression: "be proud of", meaningPT: "estar orgulhoso de", exampleFromText: "She felt proud of everything she had managed to finish.", collocations: ["be proud of your work", "be proud of yourself", "be proud of the team"])
            ],
            grammarPoints: [
        ...
        WeeklyText(
            ...
            keyChunks: [
                KeyChunk(expression: "make a list", meaningPT: "fazer uma lista", exampleFromText: "Rafael makes a quick list of everything the house needs.", collocations: ["make a shopping list", "make a mental list", "make a list of priorities"]),
                KeyChunk(expression: "stick to", meaningPT: "seguir à risca, se ater a", exampleFromText: "He sticks to his list as closely as possible.", collocations: ["stick to a budget", "stick to a plan", "stick to a diet"]),
                KeyChunk(expression: "compare prices", meaningPT: "comparar preços", exampleFromText: "He compares prices between brands.", collocations: ["compare prices online", "compare prices between stores", "compare prices carefully"]),
                KeyChunk(expression: "check the expiration date", meaningPT: "checar a data de validade", exampleFromText: "He checks the expiration dates carefully.", collocations: ["check the expiration date twice", "check the label", "check for freshness"]),
                KeyChunk(expression: "leave (something) until the last minute", meaningPT: "deixar para a última hora", exampleFromText: "People who left their shopping until the last minute.", collocations: ["leave your homework until the last minute", "leave it until the last minute", "leave packing until the last minute"])
            ],
            grammarPoints: [
        ...
        WeeklyText(
            ...
            keyChunks: [
                KeyChunk(expression: "trust your instincts", meaningPT: "confiar no seu instinto", exampleFromText: "Beatriz has gradually learned to trust her instincts in the kitchen.", collocations: ["trust your instincts in the kitchen", "trust your gut", "trust your own judgment"]),
                KeyChunk(expression: "have on hand", meaningPT: "ter à mão/disponível", exampleFromText: "She decided to improvise with whatever she had on hand.", collocations: ["whatever you have on hand", "keep ingredients on hand", "have cash on hand"]),
                KeyChunk(expression: "a creative outlet", meaningPT: "uma válvula de escape criativa", exampleFromText: "Cooking has become less of a chore and more of a creative outlet.", collocations: ["find a creative outlet", "cooking as a creative outlet", "a healthy outlet for stress"]),
                KeyChunk(expression: "get the proportions right", meaningPT: "acertar as proporções", exampleFromText: "She consults recipes to get the proportions right for baking.", collocations: ["get the balance right", "get the timing right", "get the seasoning right"]),
                KeyChunk(expression: "taste as you go", meaningPT: "provar enquanto cozinha", exampleFromText: "What she enjoys most is tasting as she goes.", collocations: ["adjust the seasoning as you go", "taste and adjust", "season to taste"])
            ],
            grammarPoints: [
        ...
        WeeklyText(
            ...
            keyChunks: [
                KeyChunk(expression: "an extension of", meaningPT: "uma extensão de", exampleFromText: "She treated the weekend as an extension of the working week.", collocations: ["an extension of the working week", "an extension of her personality", "a natural extension of"]),
                KeyChunk(expression: "ring-fence", meaningPT: "reservar/proteger (tempo ou recursos)", exampleFromText: "She began to ring-fence a few hours each weekend.", collocations: ["ring-fence some time", "ring-fence a budget", "ring-fence resources"]),
                KeyChunk(expression: "give way to", meaningPT: "dar lugar a", exampleFromText: "The discomfort gave way to something closer to relief.", collocations: ["give way to relief", "give way to panic", "guilt gave way to acceptance"]),
                KeyChunk(expression: "out of habit", meaningPT: "por hábito, automaticamente", exampleFromText: "She'd catch herself reaching for her laptop out of sheer habit.", collocations: ["reach for something out of habit", "do it out of habit", "say it out of sheer habit"]),
                KeyChunk(expression: "draw a line between", meaningPT: "traçar um limite entre", exampleFromText: "She's learned to draw a firmer line between what genuinely needs doing and what doesn't.", collocations: ["draw a line between work and life", "draw a firmer line", "draw the line somewhere"])
            ],
            grammarPoints: [
